...
const healthMocks = vi.hoisted(() => ({
  ...
  state: {
    ...
    schemaVersion: 32 as number | null,
...
describe("GET /api/health", () => {
  beforeEach(() => {
    ...
    healthMocks.state.schemaVersion = 32
  ...
  test("reports a healthy production stack without returning secret values", async () => {
    ...
    expect(body.checks.databaseSchema).toEqual({
      ...
      detail: "Current v32; expected v32",
    })
  ...
  test("warns when the database is ahead of a rolled-back application", async () => {
    ...
    expect(body.checks.databaseSchema.detail).toBe("Current v33; application expects v32")
  })
