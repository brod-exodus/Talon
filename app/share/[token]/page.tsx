...
export default function SharePage() {
  ...
  return (
    <div className="relative z-10 min-h-screen text-foreground">
      {/* ── Sticky header ──────────────────────────────────────────────── */}
      <header className="sticky top-0 z-10 border-b border-border bg-card backdrop-blur-xl">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-4 py-4 sm:px-6">
          <div>
            <p className="mb-0.5 text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
              Talon · Shared List
            </p>
