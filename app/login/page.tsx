...
export default function LoginPage() {
  ...
  return (
    <main className="grid-texture relative z-10 flex min-h-screen items-center justify-center px-6 py-12">
      <Card className="w-full max-w-md overflow-hidden">
        <CardHeader>
          <div className="mb-2 flex flex-col items-start gap-3">
            ...
            <p className="text-xs font-medium uppercase tracking-[0.18em] text-muted-foreground">Team access</p>
          </div>
          <CardDescription>
            {mode === "signin"
